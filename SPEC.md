...
T100|.|[C/W] WP2 bombay terrain: 2-3m seaward fall, trapezoid berm (40vox h, 50 crest, 140 base, noise-jitter crest, 3 ramp cuts: AveC/ESt/Aisle-end), playa salt crust + cracked mud + bone-shell band, sea waterFill east, surface 10-20vox below town. East-facing stampBeach generalization (axis param)|T98,T99|V18,V9
T101|.|[C] WP3 bombay streets: 6 avenues @300vox pitch (keep 'no Avenue E' quirk: A,B,C,E-St,F,Aisle-of-Palms), 5 streets @500/500/600/600vox gaps, 2 dirt alleys, dead-end stubs past 5th (B/C/E-St), Ave-A desert spur 600-800vox, 5th St bend, cracked-asphalt stamp (patches → mud/sand)|T98,T99|V2
...
T103|.|[C] WP5 bombay Ski Inn + civic: Ski Inn 100×80vox @ Ave A (tan+brown, flat roof, cooler, SKI-INN lettering, pole sign, walkable interior: bar counter/stools/jukebox/pool table/dollar-bill wall mat), Bombay Market, fire station, American Legion, church, comms mast + 3 dishes|T98,T99|V19
