...
T98|.|[C] WP-L bombay layout contract: DistrictKind 'bombay'+'bombayBeach', districtKindAt rules (town bi9-10/bj2-5, shore bi11+margin east), makeBombay() → streets/alleys/lots+condition enum/landmarks/berm polyline/playa extent/art list. Deterministic per seed. Per docs/research/bombay-beach.md §2|T97|V2,V20
