...
T87|.|[P] budget/amortize T86 structural passes (B32): stress+coarse run synchronously in the edit tick — headless dig max ~38ms, bomb max ~68ms vs T63 gate p99<20ms. Spread coarse rebuild/flood across ticks or worker, keep decisions deterministic (fixed schedule, V17a)|T86|B32,V7,V17
...
B31|2026-07-07|mp-e2e harness RED at HEAD baseline (pre-T86): both pages rAF-starve (12-69s gaps), guest stalls at tick barrier, host drops P2 — hashes AGREE at every verified tick incl. scripted destruction, so no desync; machine/harness issue, not sim state|investigate separately; T86 MP proof = verified-tick hash agreement + 510 unit determinism
B32|2026-07-07|T86 stress+coarse passes add per-EDIT tick spikes (headless: dig max ~38ms, bomb max ~68ms vs B23/T63 gate p99<20ms) — collapse decisions run synchronously in the edit tick|T87 budget/amortize structural passes|
