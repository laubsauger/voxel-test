...
T54|.|[P] projectile entities: thrown bomb = sim projectile (arc, bounce, fuse timer → explode op at rest point), deterministic, rendered + trailed|T13|B13,V1,V2
T52|.|[UI] audio wiring per INTEGRATION-audio.md (B9: engine init on gesture, listener sync, footstep poller, event hooks) + fullscreen setting & quick-access + mute quick-access in main/pause menus + ESC toggles pause closed (B10)|T34,T37|B9,B10,I.audio,I.settings
